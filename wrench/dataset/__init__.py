...
text_datasets = ['agnews', 'imdb', 'sms', 'trec', 'yelp', 'youtube', 'medabs', 'clickbait', 'finance', 'claude', 'massive', 'chemprot', 'paper', 'pubmed']
...
def load_dataset(data_home, dataset, dataset_type=None, extract_feature=False, extract_fn=None, label_num=None, **kwargs):
    ...
    if label_num is not None:
        dataset_path = Path(data_home) / dataset / str(label_num)
    else:
